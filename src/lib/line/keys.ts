import { pad32, publicKey, toHex } from "./encoding.ts";
...
export const ISSUER_PK = toHex(publicKey(pad32("line:demo:issuer")));
export const MERCHANT_PK = toHex(publicKey(pad32("line:demo:merchant")));
